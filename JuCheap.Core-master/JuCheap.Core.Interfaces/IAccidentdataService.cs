...
namespace JuCheap.Core.Interfaces
{
    ...
    public interface IAccidentdataService
    {
        ...
        /// <returns></returns>
        Task<int> Add(AccidentdataDto dto);
        ...
        /// <param name="dto">模型</param>
        /// <returns></returns>
        Task<bool> Update(AccidentdataDto dto);
        ...
        /// <returns></returns>
        Task<AccidentdataDto> Find(string id);
        ...
        /// <returns></returns>
        Task<PagedResult<AccidentdataDto>> Search(BaseFilter filters);
